...
• <code>@менеджер (или без @, просто имя фамилия) дата время сумма формат канал / комментарий</code>
...
<b>Примечания:</b>
• Любые варианты «русский бизнес»/«рб» сохраняются как <i>Русский Бизнес | Экономика</i>
• Все, что после названия канала (через «/», «|», «—», двойной пробел) — это комментарий
        """
